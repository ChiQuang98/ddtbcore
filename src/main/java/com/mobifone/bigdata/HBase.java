...
class HBase {
    ...
    public static void main(String[] args) throws IOException, Exception {
        try {
            PropertyConfigurator.configure(AppConfig.getConfLocation() + "/" + "log4j.properties");
            Properties properties = AppConfig.getAppConfigProperties();
...
//            long TTLSYS = 3*60*60*1000;
            long TTLSYS = Long.parseLong(properties.getProperty("nat.timexpried"));
//            long TTLMDO = 7*24*60*60*1000;
//            long TTLMDO = 60*1000;
            long TTLMDO = Long.parseLong(properties.getProperty("mdo.timeexpried"));
            logger.info("TTLSYS: "+TTLSYS);
            logger.info("TTLMDO: "+TTLMDO);
            int portMDO = 11000;
            int portSYS = 11001;
